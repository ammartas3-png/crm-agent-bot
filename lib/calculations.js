...
function hasActiveFilterValue(value) {
  if (Array.isArray(value)) {
    return value.some((item) => hasActiveFilterValue(item));
  }
  if (value && typeof value === "object") {
    return Object.values(value).some((item) => hasActiveFilterValue(item));
  }
  if (typeof value === "number") {
...
function hasActiveFilters(filters = {}) {
  return Object.values(filters || {}).some((value) => hasActiveFilterValue(value));
}
