...
async function loadDashboardReportUncached(accessContext, query = {}, options = {}) {
  ...
  // zeros) using their roster desk/team/status. Only for the plain agent-grouped
  // builder — not comparison/traffic/leadsplitter/benchmark/last-4/agent-plan or
  // a column pivot.
  ...
  const isStandardAgentReport =
    ...
    !String(query.columnDimension || "").trim();
