...
const REPORT_TOO_HEAVY_ROW_LIMIT = 180_000;
const REPORT_TOO_HEAVY_COMPLEXITY_LIMIT = 9_000_000;
...
export async function loadDashboardReport(accessContext, query = {}, options = {}) {
  ...
  if (reportMode === "specific") {
    ...
    if (
      modeRowsCombined.length > REPORT_TOO_HEAVY_ROW_LIMIT ||
      complexityScore > REPORT_TOO_HEAVY_COMPLEXITY_LIMIT
    ) {
