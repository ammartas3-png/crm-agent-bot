...
function addComparisonReportSheets(workbook, report = {}, query = {}) {
  const tables = buildComparisonTables(report?.table || [], query.comparisonSelections || {});
...
export async function dashboardReportWorkbookBuffer(report = {}, query = {}) {
  ...
  } else if (isComparisonReportQuery(query) && report.tableType === "builder") {
    addComparisonReportSheets(workbook, report, query);
